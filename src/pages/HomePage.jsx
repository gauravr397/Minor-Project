...
function HomePage() {
  ...
  return (
    <Box className="App" backgroundColor="#faebd7">
      <NavBar />
      ...
      <Container
        ...
        maxWidth="md"
        backgroundColor="rgb(226, 170, 98)"
      >
        <Box sx={{ mb: 2 }} background-color="#8d6026">
          <Typography variant="h2" component="h1" gutterBottom>
            🧑‍🤝‍🧑 CrowdFunding :{" "}
            <span component="h2">Definitely, You Can Donate More</span>
          </Typography>
          ...
          <Typography variant="body1">
            ...
            2. Donate to a campaign <br />
            3. Abort a campaign <br />
            4. End and withdraw a campaign
          </Typography>
        </Box>
        <Box sx={{ mt: 4, mb: 2 }}>
          <Stack>
